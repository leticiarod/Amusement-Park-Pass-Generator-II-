//
//  AmusementParkPassGenerator__II_Tests.swift
//  AmusementParkPassGenerator (II)Tests
//
...
import XCTest
@testable import AmusementParkPassGenerator__II_

class AmusementParkPassGenerator__II_Tests: XCTestCase {
